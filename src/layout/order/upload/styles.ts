...
const Upload = {
    ...
    SubsPage: styled.text`
        ...
        line-height: 20px;
    `,
    ContainerUpload: styled.div<{error: boolean}>`
        display: flex;
        flex-direction: row;
        ...
        height: 40px;
        border-radius: 4px;
        border: 1px solid ${props => props.error ? colors.red : '#E9E9EA'};
    `,
    ...
    TextButton: styled.text`
        ...
        text-align: center;
    `,
    Description: styled.text<{error: boolean}>`
        font-size: 12px;
        font-weight: 400;
        line-height: 22px;
        color: ${props => props.error ? colors.red : '#4C4F54'};
