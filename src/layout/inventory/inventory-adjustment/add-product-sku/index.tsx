...
import { DropdownOption, Icon, PaginationComponent, PagginationFilter } from '@/components';
      ...
      <Content>
        <div className="wrapper-bg-light" style={{ width: 'auto' }}>
          <p className="text-primary" style={{ fontSize: 12 }}>
            INVENTORI&nbsp; / &nbsp;ADJUSTMENT&nbsp; / &nbsp;{edit ? 'EDIT ' : 'TAMBAH '}
            ADJUSTMENT&nbsp; / &nbsp;
            <span className="text-header-sm-seconds">Pilih SKU Adjustment</span>
          </p>
          <h3>Pilih SKU Adjustment</h3>
                          ...
                          >
                            <div>
                              <Image
                                width={44}
                                height={44}
                                src={option?.images ? option?.images  : ilustrationCamera}
                          ...
                          >
                            <div>
                                <Image
                                  width={44}
                                  height={44}
                                  src={option?.images && option.images.length > 0 ? option?.images  : ilustrationCamera}
                                  style={{ alignSelf: 'center' }}
                                  alt="Image Product"
                                />
                            </div>
            ...
            >
              <div className="d-flex">
                ...
                <Button
                  ...
                  disabled={disableButton || pagination.totalRecord > 0 ? false : true}
                  color="primary"
