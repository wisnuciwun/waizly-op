...
import { getActivityHistorySubAccount } from '@/services/subAccount';
...
export default function ActivityHistorySubAccount() {
  ...
  const fetchGetActivityHistory = async () => {
    try {
      const res = await getActivityHistorySubAccount(
        idParams,
      ...
      <Content>
        <PreviewCard>
          <p style={{ fontSize: 12, fontWeight: 400 }}>
            PENGATURAN &nbsp; / PENGGUNA / &nbsp;DETAIL PENGGUNA&nbsp; /
            &nbsp;
